...
export const Media = () => {
    return (
        <StyledMedia>
            <HeaderSEO>
                Portfolio, Frontend Developer, UI/UX Designer, Web Development, Responsive Design, JavaScript, React, HTML, CSS, Bootstrap, Tailwind CSS,
                ...
                Портфолио, Фронтенд-разработчик, UI/UX дизайнер, Веб-разработка, Адаптивный дизайн, JavaScript, React, HTML, CSS, Bootstrap, Tailwind CSS,
